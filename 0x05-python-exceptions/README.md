...
2. Write a function that executes a function safely.
...
4. Create three C functions that print some basic info about Python lists, Python bytes an Python float objects.
